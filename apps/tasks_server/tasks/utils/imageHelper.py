...
# from apps.helpers.db.types import ImageRead
...
#     def get_image_metadata(self, image_path: str) -> Optional[ImageRead]:
...
#     def update_image_metadata(self, image_path: str, metadata: ImageRead) -> bool:
